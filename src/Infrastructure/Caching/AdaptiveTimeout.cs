namespace Alphacloud.Common.Infrastructure.Caching
{
    ...
    [PublicAPI]
    [UsedImplicitly]
    public class AdaptiveTimeout : ILocalCacheTimeoutStrategy
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="AdaptiveTimeout" /> class using default values.
        ///     Local cache TTL is 10%, with range from 5 seconds to 5 minutes.
        /// </summary>
        public AdaptiveTimeout() : this(TimeSpan.FromSeconds(5), TimeSpan.FromMinutes(5), 10.0)
        {
        }

        /// <summary>
        ///     Initializes a new instance of the <see cref="AdaptiveTimeout" /> class.
        /// </summary>
